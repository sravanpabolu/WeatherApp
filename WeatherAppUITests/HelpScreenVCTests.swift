...
class HelpScreenVCTests: XCTestCase {
    ...
    func testHelpScreen() throws {
        
        let app = XCUIApplication()
        app.navigationBars["Weather"].children(matching: .button).element(boundBy: 2).tap()
